...
public class LatexPaintPanelView extends javax.swing.JPanel
{
    public LatexPaintPanelView()
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        redToggleButton.setText("Boysen Latex - Red");

        blueToggleButton.setText("Boysen Latex - Blue");

        blackToggleButton.setText("Boysen Latex - Black");
        ...
        whiteToggleButton.setText("Boysen Latex - White");
        ...
        greenToggleButton.setText("Boysen Latex - Green");
        ...
        yellowToggleButton.setText("Boysen Latex - Yellow");
        yellowToggleButton.setPreferredSize(new java.awt.Dimension(200, 200));

        pinkToggleButton.setText("Boysen Latex - Pink");
        ...
        purpleToggleButton.setText("Boysen Latex - Purple");
        ...
        orangeToggleButton.setText("Boysen Latex - Orange");
        ...
        brownToggleButton.setText("Boysen Latex - Brown");
        ...
        beigeToggleButton.setText("Boysen Latex - Beige");
        ...
        greyToggleButton.setText("Boysen Latex - Grey");

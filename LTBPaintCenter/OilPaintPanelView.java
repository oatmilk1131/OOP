...
public class OilPaintPanelView extends javax.swing.JPanel
{
    public OilPaintPanelView()
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        redToggleButton.setText("Boysen oil - Red");

        blueToggleButton.setText("Boysen Oil - Blue");
        ...
        blackToggleButton.setText("Boysen Oil - Black");

        whiteToggleButton.setText("Boysen Oil - White");
        ...
        greenToggleButton.setText("Boysen Oil - Green");
        ...
        yellowToggleButton.setText("Boysen Oil - Yellow");
        yellowToggleButton.setPreferredSize(new java.awt.Dimension(200, 200));

        pinkToggleButton.setText("Boysen Oil - Pink");
        ...
        purpleToggleButton.setText("Boysen Oil - Purple");
        ...
        orangeToggleButton.setText("Boysen Oil - Orange");
        ...
        brownToggleButton.setText("Boysen Oil - Brown");
        ...
        beigeToggleButton.setText("Boysen Oil - Beige");
        ...
        greyToggleButton.setText("Boysen Oil - Grey");
